...
if __name__ == '__main__':
    ...
    for mesh_path in mesh_list:
        ...
        if os.path.exists(top_obj_name):
            data_name = "DAZ_" + mesh_folder_name + "_Top"
        ...
        if os.path.exists(bottom_obj_name):
            data_name = "DAZ_" + mesh_folder_name + "_Bottom"
        ...
        if os.path.exists(hair_obj_name):
            data_name = "DAZ_" + mesh_folder_name + "_Hair"
        ...
        if os.path.exists(outfit_obj_name):
            data_name = "DAZ_" + mesh_folder_name + "_Outfit"
        ...
        if os.path.exists(shoe_obj_name):
            data_name = "DAZ_" + mesh_folder_name + "_Shoe"
        ...
        if os.path.exists(body_obj_name):
            data_name = "DAZ_" + mesh_folder_name + "_Body"
