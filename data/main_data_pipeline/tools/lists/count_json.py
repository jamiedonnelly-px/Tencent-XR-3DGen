...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Count data number in json')
    parser.add_argument('--json_files', nargs='+',
                        help='abspath of json files')
    args = parser.parse_args()

    json_fullpath_list = args.json_files
    for json_filename in json_fullpath_list:
        data_struct = read_json(json_filename)
        number_info = check_individual_number(data_struct)
        print("%s json file number is %s" % (json_filename, str(number_info)))
