...
if __name__ == '__main__':
    ...
    for data_name in mesh_data_struct.keys():
        for mesh_name in mesh_data_struct[data_name].keys():
            if mesh_name in gender_mesh_name_set:
                mesh_data_struct[data_name][mesh_name]["Gender"] = gender_of_mesh_name
            # if "MCWY_1_" in data_name:
            #     if "_M" in mesh_name:
            #         mesh_data_struct[data_name][mesh_name]["Gender"] = "Male"
            #     elif "_F" in mesh_name:
            #         mesh_data_struct[data_name][mesh_name]["Gender"] = "Female"
            #     else:
            #         mesh_data_struct[data_name][mesh_name]["Gender"] = "Asexual"
            # elif "MCWY_2_" in data_name:
            #     if "M_" in mesh_name:
            #         if "TM_" in mesh_name:
            #             mesh_data_struct[data_name][mesh_name]["Gender"] = "Asexual"
            #         else:
            #             mesh_data_struct[data_name][mesh_name]["Gender"] = "Male"
            #     elif "F_" in mesh_name:
            #         mesh_data_struct[data_name][mesh_name]["Gender"] = "Female"
            #     else:
            #         mesh_data_struct[data_name][mesh_name]["Gender"] = "Asexual"
