...
class Fusion:
    ...
    def get_parser(self):
        ...
        parser.add_argument('--n_views', type=int, default=200,
        ...
        parser.add_argument('--focal_length_x', type=float, default=800,
                            help='Focal length in x direction.')
        parser.add_argument('--focal_length_y', type=float, default=800,
                            help='Focal length in y direction.')
        parser.add_argument('--principal_point_x', type=float, default=400,
                            help='Principal point location in x direction.')
        parser.add_argument('--principal_point_y', type=float, default=400,
    ...
    def run_render(self, filepath):
        ...
        np.savez_compressed(filepath, depth=depth_array)
    ...
    def run_fuse(self, filepath):
        ...
        depths_original = np.load(filepath)
        depths = depths_original['depth']
    ...
    def run_sample(self, filepath):
        ...
        np.savez(out_file, points=points, occupancy=occupancy,
                 loc=t_loc, scale=t_scale)
