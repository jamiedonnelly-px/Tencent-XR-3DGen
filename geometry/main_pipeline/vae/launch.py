...
from vae.utils.callbacks import (
...
from vae.utils.misc import get_rank
from vae.utils.typing import Optional
...
def main(args, extras) -> None:
    ...
    if args.typecheck:
        ...
        install_import_hook("vae", "typeguard.typechecked")
    ...
    dm = vae.find(cfg.data_type)(cfg.data)
