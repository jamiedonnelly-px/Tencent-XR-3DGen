    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                bn, vn, vns, cnd, hnd, wnd = image_dino_conds.shape
                image_dino_conds = image_dino_conds.view(bn*vn*vns, cnd, hnd, wnd)

                _, _, _, cnc, hnc, wnc = image_clip_conds.shape
                image_clip_conds = image_clip_conds.view(bn*vn*vns, cnc, hnc, wnc)
                ...
                _, s_dino, d_dino = image_latents_dino.shape
                image_latents_dino = image_latents_dino.view(bn*vn, -1, d_dino)
                ...
                _, d_clip = image_latents_clip.shape
                image_latents_clip = image_latents_clip.view(bn*vn, -1)
