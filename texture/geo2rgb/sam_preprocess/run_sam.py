...
sam_model_dir1 = "/aigc_cfs_gdp/neoshang/models/sam/sam_vit_h_4b8939.pth"
sam_model_dir2 = "/aigc_cfs_2/neoshang/models/sam/sam_vit_h_4b8939.pth"

if os.path.exists(sam_model_dir1):
    sam_model_dir = sam_model_dir1
elif os.path.exists(sam_model_dir2):
    sam_model_dir = sam_model_dir2
else:
    exit("==Wrong: sam ckpt dir not exists!")
print(f"load sam from {sam_model_dir}")
sam_predictor = sam_init(sam_model_dir, gpu)
