...
def img_seg(img_path, img_size=512):
...
def run_xyz2rgb(
    ...
    pipeline = DiffusionPipeline.from_pretrained(
        "/aigc_cfs/xibinsong/models/zero123plus_v24_4views", custom_pipeline="/aigc_cfs/xibinsong/code/zero123plus_control/zero123plus_gray/pipeline_online",
    ...
    if in_data_type == 'z123':
        cond = Image.open(img_path)
    elif in_data_type == 'mv2mesh':
