...
from server_orths.inference_orths_class import run_xyz2rgb
...
class Service:
    ...
    def __init__(self, cfg_json):
        ...
        self.controlnet = ControlNetModel.from_pretrained(
            ...
            "/aigc_cfs_gdp/xibin/z123_control/models/single_view_models/controlnet-24000/controlnet", torch_dtype=torch.float16
            )
