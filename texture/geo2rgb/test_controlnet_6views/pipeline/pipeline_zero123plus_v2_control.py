...
from diffusers.schedulers import KarrasDiffusionSchedulers, EulerAncestralDiscreteScheduler, DDPMScheduler
...
class RefOnlyNoisedUNet(torch.nn.Module):
    ...
    def forward_cond(self, noisy_cond_lat, timestep, encoder_hidden_states, class_labels, ref_dict, is_cfg_guidance, cross_attention_kwargs, **kwargs):
        if is_cfg_guidance:
            encoder_hidden_states = encoder_hidden_states[1:]
        ...
        pred_cond = self.unet(
            ...
            # cross_attention_kwargs=dict(mode="w", ref_dict=ref_dict, cond_lat=cross_attention_kwargs['cond_lat'], control_depth=cross_attention_kwargs['control_depth']),
    ...
    def forward(
        ...
        **kwargs
        ...
        print("RefOnlyNoisedUNet running!")
        ...
        cross_attention_kwargs_tmp = cross_attention_kwargs
        # for key in cross_attention_kwargs_tmp.keys():
        #     print(key)
        # breakpoint()
        ...
        return self.unet(
            ...
            class_labels=class_labels,
            # cross_attention_kwargs=dict(mode="r", ref_dict=ref_dict, is_cfg_guidance=is_cfg_guidance, cond_lat=cross_attention_kwargs['cond_lat'], control_depth=cross_attention_kwargs['control_depth']),
...
class DepthControlUNet(torch.nn.Module):
    ...
    def forward(self, sample, timestep, encoder_hidden_states, class_labels=None, *args, cross_attention_kwargs: dict, **kwargs):
        ...
        # print("depthcontrol forward!!!")
        # for key in cross_attention_kwargs.keys():
        #     print(key)
        # breakpoint()
        control_depth = cross_attention_kwargs.pop('control_depth')
        # control_depth = cross_attention_kwargs['control_depth']
        # print("control_depth: ", control_depth.shape)
        # breakpoint()
...
class Zero123PlusPipeline(diffusers.StableDiffusionPipeline):
    ...
    def prepare(self):
        ...
        # if isinstance(self.unet, (UNet2DConditionModelRamping, diffusers.models.unet_2d_condition.UNet2DConditionModelRamping)):
    ...
    def __call__(
        ...
        **kwargs
        ...
        # print("true or false? ", hasattr(self.unet, "controlnet"))
        ...
        if not output_type == "latent":
            image = unscale_image(self.vae_decode(latents, hnum=hnum, wnum=wnum, imgsize=int(width//2)))
        else:
            image = latents
    ...
    def sd_call(
        ...
        **kwargs,
        ...
        self.crss_attention_kwargs = cross_attention_kwargs
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # print("unet forward !!!")
                # for key in self._cross_attention_kwargs.keys():
                #     print("cross_attention_kwargs: ", key)
                # breakpoint()
                ...
                # perform guidance
                if self.do_classifier_free_guidance:
                    guidance_scale = max_guidance_scale - ((max_guidance_scale - min_guidance_scale) / self._num_timesteps * i)
