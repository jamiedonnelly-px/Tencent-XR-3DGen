...
from pipeline.pipeline_zero123plus_v1 import Zero123PlusPipeline
...
class Zero123plusServer:
    def __init__(
            ...
            model_name="zero123plus_v20_2unet",
            result_rmbg=True):
        """
        Args:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="zero123plus_v20_2unet")
