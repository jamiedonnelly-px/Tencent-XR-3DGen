...
if not os.path.exists(tracer_b7_ckpt_path):
    ...
    shutil.copy("/aigc_cfs/xibinsong/code/zero123plus_control/zero123plus_gray/models/tracer_b7.pth", tracer_b7_ckpt_path)
    shutil.copy("/aigc_cfs/xibinsong/code/zero123plus_control/zero123plus_gray/models/fba_matting.pth", fba_matting_path)
