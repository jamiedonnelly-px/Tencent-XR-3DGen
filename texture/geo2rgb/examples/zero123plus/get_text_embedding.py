...
torch.save(encoder_hidden_states_prompt.cpu(), "/aigc_cfs_2/neoshang/code/diffusers_triplane/configs/zero123plus/zero123plus_v24_4views/empty_prompt_embedding.pt")