...
save_path = "/aigc_cfs_2/neoshang/code/diffusers_triplane/configs/zero123plus/zero123plus_v27_1cond_4views_abs_512/unet/diffusion_pytorch_model.safetensors"
...
ramping_coefficients_tensor = torch.tensor(ramping_coefficients, dtype=weight_dtype, device="cpu")
