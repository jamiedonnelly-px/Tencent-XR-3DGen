...
image_path = "/aigc_cfs_gdp/sz/d2rgb_tex/0909/test2/bake_base/infer_image.png"
# img_dir = "/aigc_cfs_2/neoshang/code/tdmq_everything/data/data/test_quality"
save_dir = "/aigc_cfs_gdp/sz/d2rgb_tex/0909/test2/bake_base/sam"
...
print(result.size, time.time() - ts)
