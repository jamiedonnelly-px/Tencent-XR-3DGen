...
if __name__ == '__main__':
    ...
    parser.add_argument('--mesh_post_processing', type=str, default="",
                        help='mesh_post_processing')
    ...
    mesh_post_processing = args.mesh_post_processing
    ...
    if not mesh_post_processing:
        if mesh_post_processing == "resize1":
            print('resize to 1...')
        print(f"Finish geometry mesh_post_processing = {mesh_post_processing}.......")
