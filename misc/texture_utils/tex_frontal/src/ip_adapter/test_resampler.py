...
IMAGE_ENCODER_NAME_OR_PATH = "/aigc_cfs/model/IP-Adapter-plus/sdxl_models/image_encoder/"
# IMAGE_ENCODER_NAME_OR_PATH = "/aigc_cfs_2/model/CLIP-ViT-H-14-laion2B-s32B-b79K"
...
def main():
    ...
    image_proj_model = Resampler(
        ...
        heads=20,
        num_queries=16,
        embedding_dim=1664, #self.image_encoder.config.hidden_size,
