...
class SceneFlowDatasets(StereoDataset):
    def __init__(self, aug_params=None, root='/apdcephfs_cq2/share_1615605/xiaqiangdai/datasets_stereo', dstype='frames_cleanpass', things_test=False):
...
class ETH3D(StereoDataset):
    def __init__(self, aug_params=None, root='/apdcephfs_cq2/share_1615605/xiaqiangdai/datasets_stereo/ETH3D', split='training'):
...
class SintelStereo(StereoDataset):
    def __init__(self, aug_params=None, root='/apdcephfs_cq2/share_1615605/xiaqiangdai/datasets_stereo/SintelStereo'):
...
class FallingThings(StereoDataset):
    def __init__(self, aug_params=None, root='/apdcephfs_cq2/share_1615605/xiaqiangdai/datasets_stereo/FallingThings'):
...
class TartanAir(StereoDataset):
    def __init__(self, aug_params=None, root='/apdcephfs_cq2/share_1615605/xiaqiangdai/datasets_stereo', keywords=[]):
...
class KITTI(StereoDataset):
    def __init__(self, aug_params=None, root='/apdcephfs_cq2/share_1615605/xiaqiangdai/datasets_stereo/KITTI', image_set='training'):
...
class Middlebury(StereoDataset):
    def __init__(self, aug_params=None, root='/apdcephfs_cq2/share_1615605/xiaqiangdai/datasets_stereo/Middlebury', split='F'):
