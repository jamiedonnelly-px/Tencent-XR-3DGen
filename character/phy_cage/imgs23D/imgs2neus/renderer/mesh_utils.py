...
from renderer.render_utils import save_img_f32, save_img_u8
...
class GaussianExtractor(object):
    ...
    @torch.no_grad()
    def reconstruction(self, cameras, i_sem=-1):
        """
        ...
        for viewpoint_cam in tqdm(cameras): 
            ...
            render_pkg = self.render.render(viewpoint_cam, i_sem=i_sem)
