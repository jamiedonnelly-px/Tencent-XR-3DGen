...
if __name__ == "__main__":
    ...
    parser.add_argument('--json_path', default='/mnt/aigc_cfs_cq/xiaqiangdai/project/objaverse_retrieve/20240711_ruku_ok.json')
    ...
    for part_key in part_keys:
        EMB_PATH = f'retrieve_libs/emb_20240711/{part_key}/NPC_origin_img_emb.pt'
        OBJ_PATH = f'retrieve_libs/emb_20240711/{part_key}/NPC_keys.pkl'
        EMB_2_OBJ_PATH = f'retrieve_libs/emb_20240711/{part_key}/NPC_emb_idx_2_obj_idx.pkl'
        ...
        for folder_key,path in folder_keys_dict[part_key]:
            ...
            for emb_path in os.listdir(obj_path):
                ...
                id = emb_path.replace('cam-','').replace('.png.clip.embedding','')
                id = int(id)
                if id%2!=0:
                    continue
