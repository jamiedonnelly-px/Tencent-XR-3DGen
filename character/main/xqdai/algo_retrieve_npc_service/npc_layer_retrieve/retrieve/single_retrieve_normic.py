...
from retrieve.retrieval_normic import (
...
def retrive_single_txt(prompt,key_in):
    ...
    query_txt_embed = calc_txt_emb(prompt, model,tokenizer, device)
...
def test_performance():
    ...
    for key in list_test:
        ...
        text_features = calc_txt_emb(text_caption, model, tokenizer,device)
...
if __name__ == "__main__":
   ...
   webui_retrieve('jean with belt','female','trousers')