...
def glb_convert(glb_path: str, output_obj_path: str):
    ...
    glb_folder = os.path.dirname(output_obj_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_obj_path', type=str,
    ...
    glb_convert(mesh_path, output_obj_path)
