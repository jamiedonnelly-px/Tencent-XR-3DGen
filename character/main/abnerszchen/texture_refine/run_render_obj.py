...
from render.render_obj import render_obj_texture, load_obj_and_pose
...
def main():
    ...
    # Render kd
    render_obj_texture(args.in_obj, args.in_pose_json, args.out_dir, lrm_mode=args.lrm_mode, render_res=args.render_res, max_mip_level=args.max_mip_level)
