...
train_data_dir="/data5/sz/uv_datasets/mcwy2_manual_4class_pos/right_blip"
OUTPUT_DIR="/aigc_cfs_3/sz/result/tex_control_2024/xl_mcwy2_manual/g8_pos_4class_blip_1e-5_long"
...
accelerate launch --gpu_ids 8,9,10,11,12,13,14,15 --config_file ./acc8.yaml train_controlnet_sdxl.py \
