...
from dataset.utils_dataset import concatenate_images_2d, concatenate_images_horizontally, concatenate_images_vertically, parse_objs_json, load_rgba_as_rgb
from sd_tex_uv.utils_uv import make_infer_data
        ...
        for num_inference_steps in num_inference_steps_l:
            for guidance_scale in guidance_scale_l:
                ...
                sd_images = pipeline(
                    ...
                    ip_adapter_image=normal_pils,   # useless but need
                ).images
                ...
                result_pils = [pos_pils, normal_pils, edited_images, gt_pils, sd_images, render_pils]
...
def main():
    ...
    # run inference
    prompt_texts, uv_pos_paths, uv_normal_paths, uv_kd_paths, gt_render_imgs = make_infer_data(objs_dict,
