...
def parse_args():
    ...
    # parser.add_argument("--mesh_path", type=str, default = "./DMC5_Dante_0_0_0/split/body/DMC5_Dante__body.obj")
    # parser.add_argument("--dump_path", type=str, default = "./DMC5_Dante_0_0_0/split/body/smplx_and_offset_smplified.npz")
    parser.add_argument("--mesh_path", type=str, required=True)
    parser.add_argument("--dump_path", type=str, required=True)
    parser.add_argument("--matches", type=str, default=None)
    parser.add_argument("--config", choices=["daz", "vroid", "base"], default="daz")
...
def main():
    ...
    reg = SMPLRegistration(config=cfg, mesh = mesh)

    data, warpped_mesh = reg.align_daz( viz=False)
