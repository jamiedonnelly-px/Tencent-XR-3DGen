...
class SourceMesh:
    ...
    def load(self, source_v=None, source_f=None):
        ...
        if source_v is not None and source_f is not None:
            ...
            # self.mesh_processor = MeshProcessor.MeshProcessor.meshprocessor_from_array(source_v, source_f, None, self.__ttype, cpuonly=self.cpuonly, load_wks_samples=self.__use_wks, load_wks_centroids=self.__use_wks)
        else:
