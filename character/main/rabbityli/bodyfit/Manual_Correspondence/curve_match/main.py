...
smpl_path = "/home/rabbityl/workspace/auto_rig/bodyfit/Manual_Correspondence/data/smpl_mesh_1280/smpl/"
smpl_mesh = os.path.join( smpl_path , "mesh_array.npy")
with open(smpl_mesh, 'rb') as f:
...
smpl_curve = load_json( os.path.join( smpl_path, "curve.json"))


yuanmeng_path = "/home/rabbityl/workspace/auto_rig/bodyfit/Manual_Correspondence/data/yuanmeng/naked/"
yuanmeng_mesh = os.path.join( yuanmeng_path , "mesh_array.npy")
with open(yuanmeng_mesh, 'rb') as f:
...
yuanmeng_curve = load_json( os.path.join(yuanmeng_path, "curve.json"))
...
# print(json.dumps(curve_match, indent=4) )

annotations = os.path.join( yuanmeng_path, "curve_match.json")
# /home/rabbityl/workspace/auto_rig/bodyfit/Manual_Correspondence/data/yuanmeng/naked/curve_match.json
