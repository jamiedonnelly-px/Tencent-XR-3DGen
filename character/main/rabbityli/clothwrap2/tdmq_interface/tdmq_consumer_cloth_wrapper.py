...
class Consumer:
    def __init__(
        ...
        self.run_py = os.path.join(codedir, "../combine/cloth_warpper.py")
    ...
    def parse_and_run(self, msg):
        ...
        if func_name == "cloth_wrapper":
            output_path = os.path.join(os.path.dirname(in_obj_list), "smplx-path.txt")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ip_port', type=int, default=888)
